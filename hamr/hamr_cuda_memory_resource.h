#ifndef hamr_cuda_memory_resource_h
#define hamr_cuda_memory_resource_h
...
/// shared poointer to an instance of hmm::cuda_memory_resource
using p_cuda_memory_resource =
    std::shared_ptr<cuda_memory_resource>;

/// A memory resource that manages memory for use with CUDA
...
public:
    ...
    static p_cuda_memory_resource New();
    ...
    bool cpu_accessible() const override { return false; }
    ...
    { return "hmm::cuda_memory_resource"; }
