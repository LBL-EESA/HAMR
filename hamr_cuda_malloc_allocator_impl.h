#ifndef hamr_cuda_malloc_allocator_impl_h
#define hamr_cuda_malloc_allocator_impl_h
...
std::shared_ptr<T>
cuda_malloc_allocator<T, typename std::enable_if<!std::is_arithmetic<T>::value>::type>
   ::allocate(cudaStream_t str, size_t n)
{
    return cuda_malloc_async_allocator<T>::allocate(str, n);
}
...
std::shared_ptr<T>
cuda_malloc_allocator<T, typename std::enable_if<!std::is_arithmetic<T>::value>::type>
    ::allocate(cudaStream_t str, size_t n, const T &val)
{
    return cuda_malloc_async_allocator<T>::allocate(str, n, val);
}
...
std::shared_ptr<T>
cuda_malloc_allocator<T, typename std::enable_if<!std::is_arithmetic<T>::value>::type>
    ::allocate(cudaStream_t str, size_t n, const U *vals, bool cudaVals)
{
    return cuda_malloc_async_allocator<T>::allocate(str, n, vals, cudaVals);
}
