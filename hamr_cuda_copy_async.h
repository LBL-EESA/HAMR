#ifndef hamr_cuda_copy_h
#define hamr_cuda_copy_h
...
static int copy_to_cuda_from_cpu(cudaStream_t str, T *dest, const U *src, size_t n_elem,
 ...
 */
template <typename T>
static int copy_to_cuda_from_cpu(cudaStream_t str, T *dest, const T *src, size_t n_elem,
   typename std::enable_if<std::is_arithmetic<T>::value>::type * = nullptr)
{
#if !defined(HAMR_ENABLE_CUDA)
    (void) str;
 ...
 */
template <typename T, typename U>
static int copy_to_cuda_from_cuda(cudaStream_t str, T *dest, const U *src, size_t n_elem,
   typename std::enable_if<!std::is_arithmetic<T>::value>::type * = nullptr)
{
#if !defined(HAMR_ENABLE_CUDA)
    (void) str;
 ...
 */
template <typename T>
static int copy_to_cuda_from_cuda(cudaStream_t str, T *dest, const T *src, size_t n_elem,
    typename std::enable_if<std::is_arithmetic<T>::value>::type * = nullptr)
{
#if !defined(HAMR_ENABLE_CUDA)
    (void) str;
 ...
 */
template <typename T, typename U>
static int copy_to_cuda_from_cuda(cudaStream_t str, T *dest,
 ...
 */
template <typename T, typename U>
static int copy_to_cpu_from_cuda(cudaStream_t str, T *dest,
 ...
 */
template <typename T, typename U>
static int copy_to_cpu_from_cuda(cudaStream_t str, T *dest, const U *src, size_t n_elem
#if !defined(HAMR_CUDA_OBJECTS)
    ,typename std::enable_if<std::is_arithmetic<T>::value>::type * = nullptr
#endif
    )
