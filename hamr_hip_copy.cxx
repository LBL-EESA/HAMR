...
template int hamr::copy_to_hip_from_cpu<T,U>(T *dest, const U *src, size_t n_elem, void *); \
...
template int hamr::copy_to_cpu_from_hip<T,U>(T *dest, const U *src, size_t n_elem, void *);

#else

#define hamr_hip_copy_instantiate_(T, U) \
template int hamr::copy_to_hip_from_cpu<T,U>(T *dest, const U *src, size_t n_elem); \
...
template int hamr::copy_to_cpu_from_hip<T,U>(T *dest, const U *src, size_t n_elem);

#endif

#define hamr_hip_copy_instantiate__(T) \
template int hamr::copy_to_hip_from_cpu<T>(T *dest, const T *src, size_t n_elem, void *); \
...
template int hamr::copy_to_cpu_from_hip<T>(T *dest, const T *src, size_t n_elem, void *);
